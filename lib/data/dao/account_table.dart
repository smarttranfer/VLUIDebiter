...
class AccountTable {
  ...
  void onCreate(Database db, int version) {
    ...
    CREATE TABLE account (
      ...
      img TEXT NOT NULL)
    ''');
    db.execute('INSERT INTO account VALUES (0,"Cong Danh Nguyen",1000000,0,0,"assets/logo.png")');
    db.execute('INSERT INTO account VALUES (1,"DucVNV",222221541,0,0,"assets/credit.png")');
    db.execute('INSERT INTO account VALUES (2,"Tuyen DV",12025444,0,0,"assets/e-wallet.png")');
  }
